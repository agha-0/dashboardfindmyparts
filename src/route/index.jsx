...
import AddPurchase from "../components/products/AddPurchase";
import AllPurchases from "../components/products/allpurchases";
...
export const routes = [
  ...
  { path: "/products/allproducts", Component: AllProducts },
  { path: "/products/AddProduct", Component: AddProduct },
  { path: "/products/AddPurchase", Component: AddPurchase },
  { path: "/products/allpurchases", Component: AllPurchases },
  { path: "/products/category", Component: Category },
  { path: "/products/subcategory", Component: SubCategory },
