      ...
      <Col className="left-header horizontal-wrapper pl-0">
        <ul className="horizontal-menu">
                ...
                <Row>
                  ...
                  >
                    <div className="link-section">
                      ...
                      <ul
                        className={`svg-icon ${megaboxtoggle4 ? "d-none" : ""}`}
                      >
          ...
          <li className="level-menu outside">
            <a
              className={levelMenu ? "nav-link active" : "nav-link"}
              href="#javascript"
            ...
            <ul
              className="header-level-menu menu-to-be-close"
              style={levelMenu ? { display: "" } : { display: "none" }}
            >
              <li>
              ...
              <li>
                ...
                <ul className="header-level-sub-menu">
                  <li>
                    <Link
                      to={`${process.env.PUBLIC_URL}/app/users/userProfile`}
                    >
                      <User />
                  ...
                  <li>
                    <Link to={`${process.env.PUBLIC_URL}/app/users/userEdit`}>
                      <UserMinus />
                      <span>{UserEdit}</span>
                    </Link>
                  </li>
                  <li>
                    <Link to={`${process.env.PUBLIC_URL}/app/users/userCards`}>
                      <UserCheck />
              ...
              <li>
                <Link to={`${process.env.PUBLIC_URL}/app/kanban-board`}>
                  <Airplay />
                  <span>{KanbanBoard}</span>
                </Link>
              </li>
              <li>
                <Link to={`${process.env.PUBLIC_URL}/app/bookmark`}>
                  <Heart />
                  <span>{Bookmark}</span>
                </Link>
              </li>
